...
write_without_cmd 'echo "1) Connect to cluster"' "$k8s_script"
write_without_cmd 'echo "2) Show nodes"' "$k8s_script"
write_without_cmd 'echo "3) Show namespaces"' "$k8s_script"
write_without_cmd 'echo "4) Show all pods"' "$k8s_script"
write_without_cmd 'echo "5) Show namespace pods"' "$k8s_script"
write_without_cmd 'echo "6) Describe pod"' "$k8s_script"
write_without_cmd 'echo "7) Logs"' "$k8s_script"
write_without_cmd 'echo "8) Exec into pod"' "$k8s_script"
write_without_cmd 'echo "9) Restart deployment"' "$k8s_script"
write_without_cmd 'echo "10) Show services"' "$k8s_script"
write_without_cmd 'echo "11) Port forward"' "$k8s_script"
...
write_without_cmd '4) show_all_pods ;;' "$k8s_script"
write_without_cmd '5) show_ns_pods ;;' "$k8s_script"
write_without_cmd '6) describe_pod ;;' "$k8s_script"
write_without_cmd '7) logs_pod ;;' "$k8s_script"
write_without_cmd '8) exec_pod ;;' "$k8s_script"
write_without_cmd '9) restart_deployment ;;' "$k8s_script"
write_without_cmd '10) show_services ;;' "$k8s_script"
write_without_cmd '11) port_forward ;;' "$k8s_script"
